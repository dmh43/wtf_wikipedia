...
const kill_xml = function(wiki) {
  ...
  wiki = wiki.replace(/ ?< ?(ref|span|div|table|data) [a-zA-Z0-9=" ]{2,100}\/? ?> ?/g, ' '); //<ref name="asd">
  //some formatting xml, we'll keep their insides though
  wiki = wiki.replace(/ ?<[ \/]?(ref|p|sub|sup|span|nowiki|div|table|br|tr|td|th|pre|pre2|hr)[ \/]?> ?/g, ' '); //<sub>, </sub>
